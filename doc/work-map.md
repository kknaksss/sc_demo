...
| 3 | [SC-WP-04 개인스페이스](work/work-04-personal-space.md) | SC-SPEC-02 | in_dev | BE+FE | commit | - | C1·C2·C3 ✅ + **md 저작 e2e 라이브** → C4(업로드+비-md보기) 남음 |
...
| SC-SPEC-01 | 도서관 | SC-WP-03 | ready_for_qa (BE C1·FE C2·C3 ✅, 4포맷 e2e 라이브) |
